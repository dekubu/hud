...
module Hud
  ...
  class Display
    ...
    class Component
      ...
      def display(name, locals = {})
        partial_path = "app/#{name}.html.erb"
      ...
      def to_s
        begin
          if self.class.to_s.downcase.include? '::'
            template = Tilt::ERBTemplate.new("app/#{self.class.to_s.downcase.gsub("::","_")}.html.erb")
          else
            template = Tilt::ERBTemplate.new("app/#{self.class.to_s.downcase}.html.erb")
          end
